...
CREATE TABLE `xids` (
  ...
  UNIQUE KEY `xid` (`xid`),
  CONSTRAINT `xids_ibfk_1` FOREIGN KEY (`sdbid`) REFERENCES `sdb_pm` (`sdbid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `xmatch` (
  ...
  `bibcode` varchar(25) DEFAULT NULL,
...
VALUES
	(0,'bei06b','bei06b.Name','\'MIPS24\'','F24','0','F24*0.01','0','\'2006ApJ...652.1674B\'','mJy','\'\'','\'\'','',0),
	(0,'bei06b','bei06b.Name','\'MIPS70\'','F70','e_F70','F70*0.04','0','\'2006ApJ...652.1674B\'','mJy','\'\'','\'\'','',0),
	(0,'bry06','HD','\'MIPS24\'','F24','0','F24*0.01','0','\'2006ApJ...636.1098B\'','mJy','\'\'','\'\'','',0),
	(0,'bry06','HD','\'MIPS70\'','F70','e_F70','F70*0.04','0','\'2006ApJ...636.1098B\'','mJy','\'\'','\'\'','',0),
	(0,'bryden09','StarName','\'MIPS24\'','F_24','0','F_24*0.01','0','\'2009ApJ...705.1226B\'','mJy','\'\'','\'\'','',0),
	(0,'bryden09','StarName','\'MIPS70\'','F_70','e_F70','F_70*0.04','0','\'2009ApJ...705.1226B\'','mJy','\'\'','\'\'','',0),
	(0,'carp09_us','carp09_us.Name1','\'MIPS24\'','S24','e_S24','S24*0.01','0','\'2009ApJ...705.1646C\'','mJy','CONCAT(\'AOR:\',AORKEY)','CONCAT(\'Name:\',carp09_us.Name)','',0),
	(0,'carp09_us','carp09_us.Name1','\'MIPS70\'','S70','e_S70','S70*0.04','0','\'2009ApJ...705.1646C\'','mJy','CONCAT(\'AOR:\',AORKEY)','CONCAT(\'Name:\',carp09_us.Name)','',0),
	(0,'chen14_t2','chen14_t2.ID','\'MIPS24\'','F24','e_F24','F24*0.01','0','\'2014ApJS..211...25C\'','mJy','CONCAT(\'Name:\',chen14_t2.Name)','CONCAT(\'r_F24:\',r_F24)','',0),
	(0,'chen14_t2','chen14_t2.ID','\'MIPS70\'','F70','e_F70','F24*0.01','IF(l_F70=\'<\',1,0)','\'2014ApJS..211...25C\'','mJy','CONCAT(\'Name:\',chen14_t2.Name)','CONCAT(\'r_F70:\',r_F70)','',0),
	(0,'debris.misc_IR_obs','misc_IR_obs.id','band','fnu_mJy','err_mJy','0','3siglim','ref','mJy','misc_IR_obs.name','\'\'','',0),
	(0,'debris.submm_obs','submm_obs.id','CONCAT(\'WAV\',wav)','fnu_mJy','err_mJy','0','3siglim','ref','mJy','CONCAT(\'Instr:\',instrument)','\'\'','',0),
	(0,'debris.uns_multiple_comp_crossref','debris.uns_multiple_comp_crossref.sourceid LEFT JOIN debris.psffitting ON CONCAT(unsid,comps)=psffit','\'PACS100\'','1.19*IF(aprad>5,apflux,flux)','1.19*IF(aprad>5,rand_e_aper,e_flux)','0.057*IF(aprad>5,apflux,flux)','0','IF(aprad>5,\'Grant_Ap\',\'Gr','Jy','\'\'','\'\'',' AND wav=100 GROUP by psffitting.name',0),
	(0,'debris.uns_multiple_comp_crossref','debris.uns_multiple_comp_crossref.sourceid LEFT JOIN debris.psffitting ON CONCAT(unsid,comps)=psffit','\'PACS160\'','1.21*IF(aprad>8,apflux,flux)','1.21*IF(aprad>8,rand_e_aper,e_flux)','0.065*IF(aprad>8,apflux,flux)','0','IF(aprad>8,\'Grant_Ap\',\'Gr','Jy','\'\'','\'\'',' AND wav=160 GROUP by psffitting.name',0),
	(0,'debris.uns_multiple_comp_crossref','debris.uns_multiple_comp_crossref.sourceid LEFT JOIN debris.psffitting ON CONCAT(unsid,comps)=psffit','\'PACS70\'','1.16*IF(aprad>4,apflux,flux)','1.16*IF(aprad>4,rand_e_aper,e_flux)','0.0565*IF(aprad>4,apflux,flux)','0','IF(aprad>4,\'Grant_Ap\',\'Gr','Jy','\'\'','\'\'',' AND wav=70 GROUP by psffitting.name',0),
	(0,'debris.uns_multiple_comp_crossref','debris.uns_multiple_comp_crossref.sourceid LEFT JOIN debris.uns_pos ON CONCAT(unsid,comps)=uns_pos.n','\'SPIRE250\'','flux','e_flux','0.07*flux','0','\'Grant_PSF\'','Jy','\'\'','\'\'',' AND wav=250 GROUP by uns_pos.name',0),
	(0,'debris.uns_multiple_comp_crossref','debris.uns_multiple_comp_crossref.sourceid LEFT JOIN debris.uns_pos ON CONCAT(unsid,comps)=uns_pos.n','\'SPIRE350\'','flux','e_flux','0.07*flux','0','\'Grant_PSF\'','Jy','\'\'','\'\'',' AND wav=350 GROUP by uns_pos.name',0),
	(0,'debris.uns_multiple_comp_crossref','debris.uns_multiple_comp_crossref.sourceid LEFT JOIN debris.uns_pos ON CONCAT(unsid,comps)=uns_pos.n','\'SPIRE500\'','flux','e_flux','0.07*flux','0','\'Grant_PSF\'','Jy','\'\'','\'\'',' AND wav=500 GROUP by uns_pos.name',0),
	(0,'feps','feps.Name','\'IRAC3P6\'','IRAC1','IRAC1_sigint','IRAC1*0.01','0','\'2008ApJS..179..423C\'','mJy','\'\'','\'\'','',0),
	(0,'feps','feps.Name','\'IRAC4P5\'','IRAC2','IRAC2_sigint','IRAC2*0.01','0','\'2008ApJS..179..423C\'','mJy','\'\'','\'\'','',0),
	(0,'feps','feps.Name','\'IRAC5P8\'','IRAC3','IRAC3_sigint','IRAC3*0.01','0','\'2008ApJS..179..423C\'','mJy','\'\'','\'\'','',0),
	(0,'feps','feps.Name','\'IRAC8\'','IRAC4','IRAC4_sigint','IRAC4*0.01','0','\'2008ApJS..179..423C\'','mJy','\'\'','\'\'','',0),
	(0,'feps','feps.Name','\'MIPS160\'','MIPS160','MIPS160_sigint','MIPS160*0.12','0','\'2008ApJS..179..423C\'','mJy','\'\'','\'\'','',0),
	(0,'feps','feps.Name','\'MIPS24\'','MIPS24','MIPS24_sigint','MIPS24*0.01','0','\'2008ApJS..179..423C\'','mJy','\'\'','\'\'','',0),
	(0,'feps','feps.Name','\'MIPS70\'','MIPS70','MIPS70_sigint','MIPS70*0.04','0','\'2008ApJS..179..423C\'','mJy','\'\'','\'\'','',0),
	(0,'gaspar13','concat(substring(gaspar13.name,1,locate(\' \',gaspar13.name)),substring(gaspar13.name,locate(\' \',gaspa','\'MIPS24\'','f24','e24','f24*0.01','0','\'2013ApJ...768...25G\'','mJy','CONCAT(\'Xs:\',xs)','CONCAT(\'AgeFlg:\',age_flag)','',0),
	(0,'gaspar13','concat(substring(gaspar13.name,1,locate(\' \',gaspar13.name)),substring(gaspar13.name,locate(\' \',gaspa','\'MIPS70\'','f70','e70','f70*0.05','0','\'2013ApJ...768...25G\'','mJy','CONCAT(\'Xs:\',xs)','CONCAT(\'AgeFlg:\',age_flag)','',0),
	(0,'gautier07','GJ_ID','\'MIPS24\'','F24','e_F24','F24*0.01','0','\'2007ApJ...667..527G\'','mJy','CONCAT(\'SpTy:\',spec_type)','CONCAT(\'Name:\',commonName)','',0),
	(0,'gautier07','GJ_ID','\'MIPS70\'','F70','e_F70','F70*0.04','0','\'2007ApJ...667..527G\'','mJy','CONCAT(\'SpTy:\',spec_type)','CONCAT(\'Name:\',commonName)','',0),
	(0,'herscheldb.name2simbad','herscheldb.name2simbad.simbad LEFT JOIN herscheldb.psffitting on psffitting.name=name2simbad.name','\'PACS100\'','IF(aprad>5,apflux_corrected,1.19*flux_uncorrected)','IF(aprad>5,rand_e_aper,1.19*e_flux)','0.03*IF(aprad>5,apflux_corrected,flux_uncorrected)','0','IF(aprad>5,\'Grant_Ap\',\'Gr','Jy','psffitting.ObsId','\'\'',' AND wav=100 AND flux_uncorrected IS NOT NULL',0),
	(0,'herscheldb.name2simbad','herscheldb.name2simbad.simbad LEFT JOIN herscheldb.psffitting on psffitting.name=name2simbad.name','\'PACS160\'','IF(aprad>8,apflux_corrected,1.21*flux_uncorrected)','IF(aprad>8,rand_e_aper,1.21*e_flux)','0.05*IF(aprad>8,apflux_corrected,flux_uncorrected)','0','IF(aprad>8,\'Grant_Ap\',\'Gr','Jy','psffitting.ObsId','\'\'',' AND wav=160 AND flux_uncorrected IS NOT NULL',0),
	(0,'herscheldb.name2simbad','herscheldb.name2simbad.simbad LEFT JOIN herscheldb.psffitting on psffitting.name=name2simbad.name','\'PACS70\'','IF(aprad>4,apflux_corrected,1.16*flux_uncorrected)','IF(aprad>4,rand_e_aper,1.16*e_flux)','0.03*IF(aprad>4,apflux_corrected,flux_uncorrected)','0','IF(aprad>4,\'Grant_Ap\',\'Gr','Jy','psffitting.ObsId','\'\'',' AND wav=70 AND flux_uncorrected IS NOT NULL',0),
	(0,'koerner10_tab1','HIP_ID','\'MIPS24\'','F_MIPS24','e_F_MIPS24','F_MIPS24*0.01','0','\'2010ApJ...710L..26K\'','Jy','\'\'','\'\'','',0),
	(0,'koerner10_tab2','HIP_ID','\'MIPS70\'','F_MIPS70','e_F_MIPS70','F_MIPS70*0.04','0','\'2010ApJ...710L..26K\'','Jy','\'\'','\'\'','',0),
	(0,'low05','low05.star','\'MIPS24\'','F24','e_F24','F24*0.01','0','\'2005ApJ...631.1170L\'','mJy','\'\'','\'\'','',0),
	(0,'low05','low05.star','\'MIPS70\'','F70','e_F70','F70*0.04','IF(lim70 IS NOT NULL,1,0)','\'2005ApJ...631.1170L\'','mJy','\'\'','\'\'','',0),
	(0,'moor10','SourceID','\'MIPS24\'','F24','e_F24','F24*0.01','0','\'2011ApJS..193....4M\'','mJy','\'\'','\'\'','',0),
	(0,'moor10','SourceID','\'MIPS70\'','F70','e_F70','F70*0.04','0','\'2011ApJS..193....4M\'','mJy','\'\'','\'\'','',0),
	(0,'morales09_tab3a','HD_ID','\'MIPS24\'','F_24mJy','e_F24','F_24mJy*0.01','0','\'2009ApJ...699.1067M\'','mJy','\'\'','\'\'','',0),
	(0,'morales09_tab3a','HD_ID','\'MIPS70\'','F70mJy','e_F70','F70mJy*0.04','0','\'2009ApJ...699.1067M\'','mJy','\'\'','\'\'','',0),
	(0,'morales09_tab3b','HD_ID','\'MIPS24\'','F24','e_F24','F24*0.01','0','\'2009ApJ...699.1067M\'','mJy','\'\'','\'\'','',0),
	(0,'morales09_tab3b','HD_ID','\'MIPS70\'','F70','e_F70','F70*0.04','0','\'2009ApJ...699.1067M\'','mJy','\'\'','\'\'','',0),
	(1,'photometry.bes90','GJ','\'BJ_VJ\'','B_V','0','0.02','0','\'1990A&AS...83..357B\'','mag','CONCAT(\'Std?:\',STD)','\'\'','',0),
	(1,'photometry.bes90','GJ','\'VJ\'','V','0','0.02','0','\'1990A&AS...83..357B\'','mag','CONCAT(\'Std?:\',STD)','\'\'','',0),
	(1,'photometry.bes90','GJ','\'VJ_IC\'','V_I','0','0.02','0','\'1990A&AS...83..357B\'','mag','CONCAT(\'Std?:\',STD)','\'\'','',0),
	(1,'photometry.bes90','GJ','\'VJ_RC\'','V_R','0','0.02','0','\'1990A&AS...83..357B\'','mag','CONCAT(\'Std?:\',STD)','\'\'','',0),
	(1,'photometry.HIP','HIP_ID','\'HP\'','Hpmag','e_Hpmag','0','0','\'1997HIP...C......0E\'','mag','CONCAT(\'VarType:\',HvarType)','CONCAT(\'Mult:\',MultFlag)','',0),
	(1,'photometry.IRAS_FSC','IRAS_ID','\'IRAS100\'','Fnu100','e_Fnu100*Fnu100/100.0','0','IF(q_Fnu100 = 1,1,0)','\'1990IRASF.C......0M\'','Jy','CONCAT(\'Qual:\',q_Fnu100)','CONCAT(\'Conf:\',conf)','',0),
	(1,'photometry.IRAS_FSC','IRAS_ID','\'IRAS12\'','Fnu12','e_Fnu12*Fnu12/100.0','0','IF(q_Fnu12 = 1,1,0)','\'1990IRASF.C......0M\'','Jy','CONCAT(\'Qual:\',q_Fnu12)','CONCAT(\'Conf:\',conf)','',0),
	(1,'photometry.IRAS_FSC','IRAS_ID','\'IRAS25\'','Fnu25','e_Fnu25*Fnu25/100.0','0','IF(q_Fnu25 = 1,1,0)','\'1990IRASF.C......0M\'','Jy','CONCAT(\'Qual:\',q_Fnu25)','CONCAT(\'Conf:\',conf)','',0),
	(1,'photometry.IRAS_FSC','IRAS_ID','\'IRAS60\'','Fnu60','e_Fnu60*Fnu60/100.0','0','IF(q_Fnu60 = 1,1,0)','\'1990IRASF.C......0M\'','Jy','CONCAT(\'Qual:\',q_Fnu60)','CONCAT(\'Conf:\',conf)','',0),
	(1,'photometry.IRAS_PSC','IRAS_ID','\'IRAS100\'','Fnu_100','e_Fnu_100*Fnu_100/100.0','0','IF(q_Fnu_100 = 1,1,0)','\'1988IRASP.C......0J\'','Jy','CONCAT(\'Qual:\',q_Fnu_100)','CONCAT(\'Conf:\',confuse)','',0),
	(1,'photometry.IRAS_PSC','IRAS_ID','\'IRAS12\'','Fnu_12','e_Fnu_12*Fnu_12/100.0','0','IF(q_Fnu_12 = 1,1,0)','\'1988IRASP.C......0J\'','Jy','CONCAT(\'Qual:\',q_Fnu_12)','CONCAT(\'Conf:\',confuse)','',0),
	(1,'photometry.IRAS_PSC','IRAS_ID','\'IRAS25\'','Fnu_25','e_Fnu_25*Fnu_25/100.0','0','IF(q_Fnu_25 = 1,1,0)','\'1988IRASP.C......0J\'','Jy','CONCAT(\'Qual:\',q_Fnu_25)','CONCAT(\'Conf:\',confuse)','',0),
	(1,'photometry.IRAS_PSC','IRAS_ID','\'IRAS60\'','Fnu_60','e_Fnu_60*Fnu_60/100.0','0','IF(q_Fnu_60 = 1,1,0)','\'1988IRASP.C......0J\'','Jy','CONCAT(\'Qual:\',q_Fnu_60)','CONCAT(\'Conf:\',confuse)','',0),
	(1,'photometry.koen02','HIP_ID','\'BJ_VJ\'','B_V','e_B_V','0.005','0','\'2010MNRAS.403.1949K\'','mag','CONCAT(\'o_Vmag:\',o_Vmag)','CONCAT(\'Var:\',Var)','',0),
	(1,'photometry.koen02','HIP_ID','\'UJ_BJ\'','U_B','e_U_B','0.005','0','\'2010MNRAS.403.1949K\'','mag','CONCAT(\'o_Vmag:\',o_Vmag)','CONCAT(\'Var:\',Var)','',0),
	(1,'photometry.koen02','HIP_ID','\'VJ\'','Vmag','e_Vmag','0.005','0','\'2010MNRAS.403.1949K\'','mag','CONCAT(\'o_Vmag:\',o_Vmag)','CONCAT(\'Var:\',Var)','',0),
	(1,'photometry.ubvy_mean','ID_fromlid','\'BS_YS\'','b_y','e_b_y','0.013','0','\'1998A&AS..129..431H\'','mag','CONCAT(\'Comp:\',m_LID)','\'\'','',0),
	(1,'photometry.ubvy_mean','ID_fromlid','\'STROMC1\'','c1','e_c1','0.018','0','\'1998A&AS..129..431H\'','mag','CONCAT(\'Comp:\',m_LID)','\'\'','',0),
	(1,'photometry.ubvy_mean','ID_fromlid','\'STROMM1\'','m1','e_m1','0.014','0','\'1998A&AS..129..431H\'','mag','CONCAT(\'Comp:\',m_LID)','\'\'','',0),
	(1,'photometry.UBV_mean','ID_fromlid','\'BJ_VJ\'','B_V','e_B_V','0.02','0','\'2006yCat.2168....0M\'','mag','CONCAT(\'Comp:\',m_LID)','CONCAT(\'n_B_V:\',n_B_V)','',0),
	(1,'photometry.UBV_mean','ID_fromlid','\'UJ_BJ\'','U_B','e_U_B','0.028','0','\'2006yCat.2168....0M\'','mag','CONCAT(\'Comp:\',m_LID)','CONCAT(\'n_U_B:\',n_U_B)','',0),
	(1,'photometry.UBV_mean','ID_fromlid','\'VJ\'','Vmag','e_Vmag','0.02','0','\'2006yCat.2168....0M\'','mag','CONCAT(\'Comp:\',m_LID)','CONCAT(\'n_Vmag:\',n_Vmag)','',0),
	(0,'plav09_tab2','plav09_tab2.ID','\'MIPS24\'','flux_mjy_24','flux_mJy_24_error','flux_mjy_24*0.01','0','\'2009ApJ...698.1068P\'','mJy','\'\'','\'\'','',0),
	(0,'plav09_tab2','plav09_tab2.ID','\'MIPS70\'','flux_mjy_70','flux_mJy_70_error','flux_mjy_70*0.01','IF(flux_70_limit=\'<\',1,0)','\'2009ApJ...698.1068P\'','mJy','\'\'','\'\'','',0),
	...
	(0,'su06','HD_ID','\'MIPS70\'','F70','e_F70','F70*0.04','IF(l_F70=\'<\',1,0)','\'2006ApJ...653..675S\'','mJy','CONCAT(\'Age:\',age)','\'\'','',0),
	(0,'TDSC_main_suppl','TDSC_ID','\'BT\'','BTmag','e_BTmag','0.006','0','\'2002A&A...384..180F\'','mag','CONCAT(\'Comp:\',m_TDSC)','CONCAT(\'MagFlg:\',magflg)','AND magflg NOT REGEXP(\'T|B|V|H\')',0),
	(0,'TDSC_main_suppl','TDSC_ID','\'VT\'','VTmag','e_VTmag','0.006','0','\'2002A&A...384..180F\'','mag','CONCAT(\'Comp:\',m_TDSC)','CONCAT(\'MagFlg:\',magflg)','AND magflg NOT REGEXP(\'T|B|V|H\')',0),
	(0,'trilling07','trilling07.name','\'MIPS24\'','F24','e_F24','F24*0.01','0','\'2007ApJ...658.1289T\'','mJy','\'\'','\'\'','',0),
	(0,'trilling07','trilling07.name','\'MIPS70\'','F70','e_F70','F70*0.04','0','\'2007ApJ...658.1289T\'','mJy','\'\'','\'\'','',0),
	(0,'trilling08','trilling08.ID','\'MIPS24\'','F24','0','F24*0.01','0','\'2008ApJ...674.1086T\'','mJy','\'\'','\'\'','',0),
	(0,'trilling08','trilling08.ID','\'MIPS70\'','F70','e_F70','F70*0.04','0','\'2008ApJ...674.1086T\'','mJy','\'\'','\'\'','',0),
	(0,'zuckerman11_tab10','Star','\'MIPS24\'','F24','0','F24*0.01','0','\'2011ApJ...732...61Z\'','mJy','\'\'','\'\'','',0),
	(0,'zuckerman11_tab10','Star','\'MIPS70\'','F70','0','F70*0.04','0','\'2011ApJ...732...61Z\'','mJy','\'\'','\'\'','',0),
	(0,'zuckerman11_tab8','Star','\'MIPS24\'','F24','0','F24*0.01','0','\'2011ApJ...732...61Z\'','mJy','\'\'','\'\'','',0),
	(0,'zuckerman11_tab8','Star','\'MIPS70\'','F70','0','F70*0.04','0','\'2011ApJ...732...61Z\'','mJy','\'\'','\'\'','',0),
	(0,'zuckerman11_tab9','Star','\'MIPS24\'','F24','0','F24*0.01','0','\'2011ApJ...732...61Z\'','mJy','\'\'','\'\'','',0),
	(0,'zuckerman11_tab9','Star','\'MIPS70\'','F70','0','F70*0.04','0','\'2011ApJ...732...61Z\'','mJy','\'\'','\'\'','',0);
