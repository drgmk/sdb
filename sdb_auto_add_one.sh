...
python3 /Users/grant/astro/projects/sdf/sdf/fit.py -f $sdbid/public/$sdbid-rawphot.txt --no-spectra -w -b
python3 /Users/grant/astro/projects/sdf/sdf/fit.py -f $sdbid/public/$sdbid-rawphot.txt -u -w -b
popd
