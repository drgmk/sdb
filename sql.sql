...
ALTER TABLE galex DROP FOREIGN KEY sdbid_gal;
ALTER TABLE galex DROP PRIMARY KEY;
ALTER TABLE galex ADD PRIMARY KEY sdbid_gal (sdbid);
ALTER TABLE galex ADD CONSTRAINT sdbid_gal FOREIGN KEY (sdbid) REFERENCES sdb_pm (sdbid);

ALTER TABLE apass DROP FOREIGN KEY sdbid_ap;
ALTER TABLE apass DROP PRIMARY KEY;
ALTER TABLE apass ADD PRIMARY KEY sdbid_ap (sdbid);
ALTER TABLE apass ADD CONSTRAINT sdbid_ap FOREIGN KEY (sdbid) REFERENCES sdb_pm (sdbid);

ALTER TABLE gaia DROP FOREIGN KEY sdbid_ga;
ALTER TABLE gaia DROP PRIMARY KEY;
ALTER TABLE gaia ADD PRIMARY KEY sdbid_ga (sdbid);
ALTER TABLE gaia ADD CONSTRAINT sdbid_ga FOREIGN KEY (sdbid) REFERENCES sdb_pm (sdbid);

ALTER TABLE gaia_dr2 DROP FOREIGN KEY sdbid_ga2;
ALTER TABLE gaia_dr2 DROP PRIMARY KEY;
ALTER TABLE gaia_dr2 ADD PRIMARY KEY sdbid_ga2 (sdbid);
ALTER TABLE gaia_dr2 ADD CONSTRAINT sdbid_ga2 FOREIGN KEY (sdbid) REFERENCES sdb_pm (sdbid);
